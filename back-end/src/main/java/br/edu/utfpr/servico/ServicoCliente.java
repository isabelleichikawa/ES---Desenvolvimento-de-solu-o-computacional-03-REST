...
public class ServicoCliente {
    ...
    public ServicoCliente(){
        clientes = Stream.of(
            ClienteDTO.builder().id(1).nome("Isabelle").idade(21).telefone("xxxx-xxxx").limiteCredito(200.50)
                      .pais(PaisDTO.builder().id(3).nome("Reino Unido").sigla("RU").codigoTelefone(44).build())
            .build(),
            ClienteDTO.builder().id(2).nome("Ichikawa").idade(24).telefone("yyyy-yyyy").limiteCredito(120.00)
                      .pais(PaisDTO.builder().id(1).nome("Brasil").sigla("BR").codigoTelefone(55).build())
            .build(),
            ClienteDTO.builder().id(3).nome("Yagi").idade(30).telefone("zzzz-zzzz").limiteCredito(303.30)
                      .pais(PaisDTO.builder().id(2).nome("Estados Unidos").sigla("EUA").codigoTelefone(33).build())
            .build()
